...
public class RobotContainer {
  ...
  private void configureBindings() {
    driverController.button(1).onTrue(new MoveElevatorToSetpoint(m_elevator, Constants.Elevator.homePos));
    driverController.button(2).onTrue(new MoveElevatorToSetpoint(m_elevator, Constants.Elevator.homePos + 500));
