...
import frc.robot.commands.Elevator.MoveOnceAngle;
...
public class StateMachine extends Command {
    ...
    private Command goToStartup() {
        switch(currentState) {
            ...
            return new ParallelCommandGroup(
                ...
                new MoveOnceAngle(elevSub, StateLocations.elevStartup)
            );
            ...
            case SHOOOTSHALLOWFRONT:
            return new SequentialCommandGroup(
                new MoveOnceAngle(elevSub, StateLocations.elevTurnHight),
                new MoveToAngle(pivSub, StateLocations.pivStartup),
                new MoveOnceAngle(elevSub, StateLocations.elevStartup)
            );
    ...
    private Command goToPickupFloor() {
        switch(currentState) {
            ...
            return new ParallelCommandGroup(
                ...
                new MoveOnceAngle(elevSub, StateLocations.elevPickupFloor)
            );
    ...
    private Command goToPickupSource() {
        switch(currentState) {
            case STARTUP:
            return new SequentialCommandGroup(
                new MoveOnceAngle(elevSub, StateLocations.elevPickupSource),
    ...
    private Command goToShootAmpTrap() {
        switch(currentState) {
            case STARTUP:
            return new SequentialCommandGroup(
                new MoveOnceAngle(elevSub, StateLocations.elevShootAmp),
    ...
    private Command goToHighRear() {
        switch(currentState) {
            case STARTUP:
            return new SequentialCommandGroup(
                new MoveOnceAngle(elevSub, StateLocations.elevHighRear),
    ...
    private Command goToShallowFront() {
        switch(currentState) {
            case STARTUP:
            return new SequentialCommandGroup(
                new MoveOnceAngle(elevSub, StateLocations.elevShallowFront),
    ...
    private Command goToSteepFront() {
        switch(currentState) {
            ...
            return new SequentialCommandGroup(
                ...
                new MoveOnceAngle(elevSub, StateLocations.elevSteepFront)
            );
    ...
    private Command goToTravel() {
        switch(currentState) {
            case STARTUP:
            return new SequentialCommandGroup(
                new MoveOnceAngle(elevSub, StateLocations.elevTravel),
